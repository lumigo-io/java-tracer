...
class AwsUtilsTest {
    ...
    void testExtractAwsAccountFromArn_happyFlow() {
        String exampleArn = "arn:aws:lambda:us-west-2:723663554526:function:tracer-test-saart-main-java8";
    ...
    void testExtractAwsTraceSuffix_happyFlow() {
        assertEquals(";Another=456;Bla=789", AwsUtils.extractAwsTraceSuffix("Root=1-2-3;Another=456;Bla=789"));
    }
