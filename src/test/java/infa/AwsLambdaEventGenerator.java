...
public class AwsLambdaEventGenerator {
    ...
    public KinesisAnalyticsFirehoseInputPreprocessingEvent kinesisAnalyticsFirehoseInputPreprocessingEvent() {
        KinesisAnalyticsFirehoseInputPreprocessingEvent kinesisFirehoseEvent= mock(KinesisAnalyticsFirehoseInputPreprocessingEvent.class);
        when(kinesisFirehoseEvent.getStreamArn()).thenReturn("kinesis-arn");
        return kinesisFirehoseEvent;
    }
    public KinesisAnalyticsStreamsInputPreprocessingEvent kinesisAnalyticsStreamsInputPreprocessingEvent() {
        KinesisAnalyticsStreamsInputPreprocessingEvent kinesisFirehoseEvent= mock(KinesisAnalyticsStreamsInputPreprocessingEvent.class);
        when(kinesisFirehoseEvent.getStreamArn()).thenReturn("kinesis-arn");
        return kinesisFirehoseEvent;
    }
    ...
    public APIGatewayProxyRequestEvent apiGatewayProxyRequestEvent() {
        ...
        APIGatewayProxyRequestEvent.ProxyRequestContext context = mock(APIGatewayProxyRequestEvent.ProxyRequestContext .class);
