...
class SpansContainerTest {
        ...
        Request awsRequest;
        @Mock
        com.amazonaws.http.HttpResponse awsHttpResponse;
        ...
        void add_aws_http_span_with_spnid_from_header_amzn() throws Exception {
                ...
                Response<String> awsResponse = new Response<>("{\"passphrase\":\"some-token\"}", awsHttpResponse);
                long startTime = System.currentTimeMillis();
        ...
        void add_aws_sdk_v2_http_span() throws Exception {
                ...
                PublishResponse response = PublishResponse.builder().messageId("fee47356-6f6a-58c8-96dc-26d8aaa4631a")
                                .build();
                ...
                SdkHttpResponse sdkHttpResponse = SdkHttpResponse.builder().headers(headers).statusCode(200).build();

                software.amazon.awssdk.core.interceptor.Context.AfterExecution requestContext = InterceptorContext
                                .builder()
                                .request(request)
        ...
        void test_reduce_http_span_size_less_than_1024() {
                HttpSpan.HttpData request = HttpSpan.HttpData.builder()
                                .headers(createStringOfSize(100))
                                .body(createStringOfSize(100))
                                .build();
                HttpSpan.HttpData response = HttpSpan.HttpData.builder()
                                .headers(createStringOfSize(100))
                                .body(createStringOfSize(100))
                                .build();
                HttpSpan httpSpan = HttpSpan.builder()
                                .info(
