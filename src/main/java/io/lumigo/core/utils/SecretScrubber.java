...
public class SecretScrubber {
  private static SecretScrubbingPatternProvider secretScrubbingUtils = new SecretScrubbingPatternProvider();
  ...
  String scrubBody(String body) {
    try {
      ...
      return scrubJsonObject(jsonObject, secretScrubbingUtils.getBodyScrubbingPatterns()).toString();
    } catch (Exception e) {
      return body;
    }
  }
